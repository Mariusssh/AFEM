...
Converted["_Open"].Parent = Converted["_AFMM"]

Converted["_UICorner"].CornerRadius = UDim.new(1, 0)
Converted["_UICorner"].Parent = Converted["_Open"]

Converted["_ImageLabel"].Image = "rbxassetid://11713358131"
...
Converted["_ImageLabel"].Size = UDim2.new(0.699999988, 0, 0.699999988, 0)
Converted["_ImageLabel"].Parent = Converted["_Open"]
...
Converted["_Frame"].Position = UDim2.new(0.5, 0, -0.379999995, 0)
Converted["_Frame"].Size = UDim2.new(8.23999977, 0, 1.38, 0)
Converted["_Frame"].ZIndex = -1
Converted["_Frame"].Parent = Converted["_Open"]
...
Converted["_Emote1"].Parent = Converted["_Frame"]

Converted["_UICorner2"].CornerRadius = UDim.new(1, 0)
Converted["_UICorner2"].Parent = Converted["_Emote1"]
...
Converted["_UIStroke2"].Parent = Converted["_Emote1"]

Converted["_UIPadding"].PaddingBottom = UDim.new(0, 5)
Converted["_UIPadding"].PaddingLeft = UDim.new(0, 5)
Converted["_UIPadding"].PaddingRight = UDim.new(0, 5)
Converted["_UIPadding"].PaddingTop = UDim.new(0, 5)
Converted["_UIPadding"].Parent = Converted["_Emote1"]
...
Converted["_Emote2"].Parent = Converted["_Frame"]

Converted["_UICorner3"].CornerRadius = UDim.new(1, 0)
Converted["_UICorner3"].Parent = Converted["_Emote2"]

Converted["_UIStroke3"].ApplyStrokeMode = Enum.ApplyStrokeMode.Border
Converted["_UIStroke3"].Color = Color3.fromRGB(255, 255, 255)
Converted["_UIStroke3"].Thickness = 2.299999952316284
Converted["_UIStroke3"].Parent = Converted["_Emote2"]

Converted["_UIPadding1"].PaddingBottom = UDim.new(0, 5)
...
Converted["_UIPadding1"].Parent = Converted["_Emote2"]
...
Converted["_Emote3"].Parent = Converted["_Frame"]

Converted["_UICorner4"].CornerRadius = UDim.new(1, 0)
Converted["_UICorner4"].Parent = Converted["_Emote3"]
...
Converted["_UIStroke4"].Parent = Converted["_Emote3"]
...
Converted["_UIPadding2"].Parent = Converted["_Emote3"]
...
Converted["_Emote4"].Parent = Converted["_Frame"]

Converted["_UICorner5"].CornerRadius = UDim.new(1, 0)
Converted["_UICorner5"].Parent = Converted["_Emote4"]
...
Converted["_UIStroke5"].Parent = Converted["_Emote4"]
...
Converted["_UIPadding3"].Parent = Converted["_Emote4"]
...
Converted["_Frame1"].BackgroundColor3 = Color3.fromRGB(64.00000378489494, 64.00000378489494, 64.00000378489494)
Converted["_Frame1"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_Frame1"].BorderSizePixel = 0
Converted["_Frame1"].Position = UDim2.new(0.0200803205, 0, 0.0323886648, 0)
Converted["_Frame1"].Size = UDim2.new(0, 472, 0, 209)
Converted["_Frame1"].Parent = Converted["_AFMM"]
...
Converted["_TextLabel"].Text = "Editing Emote 1"
...
Converted["_TextLabel"].Position = UDim2.new(0.0550847463, 0, 0.105263159, 0)
Converted["_TextLabel"].Size = UDim2.new(0.423728824, 0, 0.239234447, 0)
...
Converted["_NameInput"].Parent = Converted["_Frame1"]

Converted["_UICorner7"].CornerRadius = UDim.new(0, 20)
Converted["_UICorner7"].Parent = Converted["_NameInput"]
...
Converted["_TextLabel1"].Text = "Emote name"
...
Converted["_TextLabel1"].Parent = Converted["_NameInput"]
...
Converted["_AnimationId"].Parent = Converted["_Frame1"]

Converted["_UICorner8"].CornerRadius = UDim.new(0, 20)
Converted["_UICorner8"].Parent = Converted["_AnimationId"]
...
Converted["_TextLabel2"].Text = "Emote animation ID"
...
Converted["_TextLabel2"].Position = UDim2.new(0.0471014492, 0, 0.122807018, 0)
Converted["_TextLabel2"].Size = UDim2.new(0.673913062, 0, 0.298245609, 0)
Converted["_TextLabel2"].Parent = Converted["_AnimationId"]
...
Converted["_Save"].Parent = Converted["_Frame1"]

Converted["_UICorner9"].CornerRadius = UDim.new(0, 20)
Converted["_UICorner9"].Parent = Converted["_Save"]
...
Converted["_UIPadding4"].Parent = Converted["_Save"]
...
Converted["_Animationinspection"].Parent = Converted["_Frame1"]

Converted["_UICorner10"].CornerRadius = UDim.new(0, 20)
Converted["_UICorner10"].Parent = Converted["_Animationinspection"]

Converted["_UIPadding5"].PaddingLeft = UDim.new(0, 5)
Converted["_UIPadding5"].PaddingRight = UDim.new(0, 5)
Converted["_UIPadding5"].Parent = Converted["_Animationinspection"]
...
Converted["_AnimationInspection"].Name = "AnimationInspection"
Converted["_AnimationInspection"].Parent = Converted["_AFMM"]

Converted["_UICorner11"].CornerRadius = UDim.new(0, 20)
Converted["_UICorner11"].Parent = Converted["_AnimationInspection"]
...
Converted["_UICorner12"].Parent = Converted["_TextButton"]
...
Converted["_UIPadding6"].Parent = Converted["_TextButton"]
...
Converted["_Frame2"].Position = UDim2.new(0.0281124506, 0, 0.235553905, 0)
Converted["_Frame2"].Size = UDim2.new(0.423025429, 0, 0.522941947, 0)
Converted["_Frame2"].Parent = Converted["_AnimationInspection"]

Converted["_UICorner13"].CornerRadius = UDim.new(0, 20)
...
Converted["_TextLabel6"].Parent = Converted["_Frame2"]
...
Converted["_UIStroke6"].Parent = Converted["_TextLabel7"]

Converted["_UICorner14"].CornerRadius = UDim.new(0, 10)
Converted["_UICorner14"].Parent = Converted["_TextLabel7"]
...
Converted["_UIPadding7"].PaddingTop = UDim.new(0, 4)
Converted["_UIPadding7"].Parent = Converted["_TextLabel7"]
...
local function UQZJ_fake_script() -- Fake Script: StarterGui.AFMM.Open.LocalScript
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		if not open then
			...
			ts:Create(script.Parent.Frame, TweenInfo.new(1.5, Enum.EasingStyle.Elastic, Enum.EasingDirection.Out), {
			...
			db = true
			open = false
			local l = ts:Create(script.Parent.Frame, TweenInfo.new(0.8, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {
...
local function SUEGTZ_fake_script() -- Fake Script: StarterGui.AFMM.Open.Frame.Emote1.LocalScript
	...
	if emoteData['emote' .. emoteSlot] then
		...
		script.Parent.MouseButton1Click:Connect(function()
			...
			if not s then
				...
				script.Parent.Parent.Parent.Toggle:Fire()
			end
	...
	local function onButtonClicked()
		...
		task.spawn(function()
			task.wait(0.5)
			if isHeld then
				script.Parent.Parent.Parent.Edit:Fire(emoteSlot)
			end
		end)
	end
...
local function SLQOFRL_fake_script() -- Fake Script: StarterGui.AFMM.Frame.LocalScript
	...
	script.Parent.Save.MouseButton1Click:Connect(function()
		...
		emoteData['emote' .. slot] = {
			...
			id = tonumber(script.Parent.AnimationId.TextBox.Text)
		}
...
coroutine.wrap(SUEGTZ_fake_script)()
coroutine.wrap(AHVVDFI_fake_script)()
coroutine.wrap(VCGFF_fake_script)()
coroutine.wrap(IOURQC_fake_script)()
coroutine.wrap(UAGPVWP_fake_script)()
coroutine.wrap(SLQOFRL_fake_script)()
coroutine.wrap(KXIHODL_fake_script)()
coroutine.wrap(CRAS_fake_script)()
coroutine.wrap(AVHENQ_fake_script)()
